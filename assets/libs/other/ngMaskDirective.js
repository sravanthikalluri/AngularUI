...
--------------------------------------------------------------------------    
   2015-07-29	  CGI	         ngMaskDirective is having the directives used in order search          
---------------------------------------------------------------------------	
*/
            ...
            post: function($scope, $element, $attrs, controller) {
              promise.then(function() {
                ...
                function parseViewValue(value) {
                  //record the current caret position  
                  var savedCaretPos = getCaret($element);
                  ...
                  try {
                    ...
                    if (value !== viewValueWithDivisors && "999-999-9999" === maskWithoutOptionals) {
                        //fix the caret problem for specific mask only 
                        if (savedCaretPos === 4 || savedCaretPos === 8) {
                            setCaret($element, savedCaretPos + 1);
                        } else {
                            setCaret($element, savedCaretPos);
                        }
                    }
      ...
      function create() {
        ...
        function removeWrongPositions(viewValueWithDivisors) {
          ...
          for (var i in wrongPositions) {
                if (wrongPositions.hasOwnProperty(i)) {
