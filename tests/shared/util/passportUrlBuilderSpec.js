describe('Passport Url Builder Testing', function () {
     ...
     */
    var passportUrlBuilder, trinetApp;
    ...
    beforeEach(function () {
        ...
        inject(function ($rootScope, $controller, $q, _$timeout_, _passportUrlBuilder_) {
            // create a scope object for us to use.
            $scope = $rootScope.$new();
            passportUrlBuilder = _passportUrlBuilder_;
    ...
    it('payrollschedule url with params testing', function () {
        ...
        var url = passportUrlBuilder('ui/PayrollPolicy/PayrollSchedule.htm', $scope.params);
