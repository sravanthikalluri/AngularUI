...
'use strict';
describe('Manage Resources Controller Testing', function () {
    var $rootScope,
        $scope,
        appConfig,
        $httpBackend,
    ...
    beforeEach(function () {
        ...
        inject(function ($injector) {
            ...
            $injector.get('$controller')('manageResourceViewCtrl', {$scope: $scope});
    ...
    describe('onload call', function () {
        it('with success response', function () {
            ...
            $httpBackend
                .whenGET(benefitsUrlConfig.policiesEmpApi + benefitsUrlConfig.policiesUrl + benefitsUrlConfig.resources.benefitPlan + '/' +
                    appConfig.companyId + '/' + appConfig.userId + '/' + 'additional-policy-details?pfClient=' + appConfig.pfClient + '&menuId=3')
                .respond(200, res);
        ...
        it('with success response and data as 0 for inner service', function () {
            var res1 = {"data": [], "_statusCode": "200", "_statusText": "OK"};
            $httpBackend
                .whenGET(benefitsUrlConfig.policiesEmpApi + benefitsUrlConfig.policiesUrl + benefitsUrlConfig.resources.benefitPlan + '/' +
                    appConfig.companyId + '/' + appConfig.userId + '/' + 'additional-policies?pfClient=' + appConfig.pfClient)
                .respond(200, response);
        ...
        it('with failure response for inner service', function () {
            var res1 = {"data": [], "_statusCode": "400", "_statusText": "OK", "_error": {"detailMessage": "error"}};
            $httpBackend
                .whenGET(benefitsUrlConfig.policiesEmpApi + benefitsUrlConfig.policiesUrl + benefitsUrlConfig.resources.benefitPlan + '/' +
                    appConfig.companyId + '/' + appConfig.userId + '/' + 'additional-policies?pfClient=' + appConfig.pfClient)
                .respond(200, response);
